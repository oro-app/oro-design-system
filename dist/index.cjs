...
function Hanger({ size = 24, color }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    import_react_native_svg.default,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react_native_svg.Path, { d: "M12 9.5V7.7a2.6 2.6 0 1 1 2.6-2.6" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react_native_svg.Path, { d: "M12 9.5L2.9 16.6a1.2 1.2 0 0 0 .8 2.1h16.6a1.2 1.2 0 0 0 .8-2.1L12 9.5z" })
      ]
    }
  );
}
...
function Icon({ name, size = "md", color = import_tokens4.colors.text }) {
  ...
  if (OroGlyph) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(OroGlyph, { size: px, color });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_vector_icons.Feather, { name, size: px, color });
}
