...
__export(index_exports, {
  ...
  componentsForMode: () => componentsForMode,
  ...
  ramp: () => ramp,
  ramps: () => ramps,
  regularSpacing: () => regularSpacing,
  regularTypography: () => regularTypography,
  semantic: () => semantic,
  shiftLightness: () => shiftLightness,
  spacing: () => spacing,
