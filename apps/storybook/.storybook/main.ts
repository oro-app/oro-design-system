...
// Absolute path to react-native-web so the alias resolves from any package
// (pnpm's strict node_modules otherwise can't resolve the bare specifier
// when it's imported from @oro/ui's linked dist).
